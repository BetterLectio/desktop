...
wget https://github.com/BetterLectio/desktop-compiler/releases/download/0.0.1/betterlectio-linux.zip
...
wget https://raw.githubusercontent.com/BetterLectio/desktop-compiler/main/installers/betterlectio.desktop
